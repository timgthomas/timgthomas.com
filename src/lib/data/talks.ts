...
const talks: ListItem[] = [
  {
    ...
    heroImageUrl: '/images/talks/living-style-guides.jpg',
    summary: '',
    description:
  ...
  },
  {
    ...
    heroImageUrl: '/images/talks/icons-and-the-web.jpg',
    summary: '',
    description:
  ...
  {
    title: 'Constructing Modern UIs with SVG',
    heroImageUrl: '/images/talks/constructing-modern-uis.jpg',
    summary: '',
    description:
  ...
  {
    title: 'Browser Invasion: Desktop Apps and the Web',
    heroImageUrl: '/images/talks/browser-invasion.jpg',
    summary: '',
    description:
  ...
  {
    title: 'Mind the Gap: Bringing Designers and Developers Together',
    heroImageUrl: '/images/talks/mind-the-gap.jpg',
    summary: '',
    description:
  ...
  {
    title: 'Chocolate-Covered Vegetables: Tasty Workflows with Broccoli',
    heroImageUrl: '/images/talks/chocolate-covered-vegetables.jpg',
    summary: '',
    description:
  ...
  },
  {
    ...
    heroImageUrl: '/images/talks/form-with-function.jpg',
    summary: '',
    description:
  ...
  },
  {
    ...
    heroImageUrl: '/images/talks/build-a-better-bootstrap.jpg',
    summary: '',
    description:
  ...
  },
  {
    ...
    heroImageUrl: '/images/talks/web-usability-on-a-budget.jpg',
    summary: '',
    description:
  ...
  {
    title: 'A Developer’s Guide to Design Frameworks (and More!)',
    heroImageUrl: '/images/talks/a-developers-guide-to-design-frameworks.jpg',
    summary: '',
    description:
